        ...
        User.findOne({
          'local.email' :  email
            ...
            if (user) {
                ...
                newUser.local.phone = req.body.number;
                newUser.local.optIn = 'yes'
                newUser.local.password = newUser.generateHash(password); // use the generateHash function in our user model



				// save the user and send text confirming signup
                newUser.save(function(err) {
                    const welcomeMsg = `Hi ${req.body.email}! Thank you for registering with 'Guardian Portal' at Demo Day and for supporting Resilient Coders. Your account will be available by the next business day`
